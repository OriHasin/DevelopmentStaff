...
collection.find({}, {"field1": 1, "field2": 1})     # Projection, fetch necessary data, _id is always by default.
...
result = collection.aggregate([
    ...
    {"$group":
          {"_id": "$category",                         # Stage 2: Group by the 'category' field which stated that by "_id" field
